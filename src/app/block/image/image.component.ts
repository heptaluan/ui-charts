  ...
  initImageData() {
    ...
    if (this.groupData || this.data.setting) {
      ...
      this.imageStyles = {
        ...
        'box-shadow': dataProps.shadow && dataProps.shadow.display ? `${Math.round(dataProps.shadow.shadowRadius * Math.cos(dataProps.shadow.shadowAngle * Math.PI / 180))}px
                       ...
                       ${dataProps.shadow.shadowBlur}px
                       ${this.colorToRGBA(dataProps.shadow.shadowColor)}` : "unset"
      };
    }
