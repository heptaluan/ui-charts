...
@Component({
  selector: 'lx-d3-chord-chart',
  templateUrl: './d3-chord-chart.component.html',
  styleUrls: ['./d3-chord-chart.component.scss']
})
export class D3ChordChartComponent implements OnInit {
  _data;
  set data(val) {
    this._data = val;
