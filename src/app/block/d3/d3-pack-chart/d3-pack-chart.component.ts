...
@Component({
  selector: 'lx-d3-pack-chart',
  templateUrl: './d3-pack-chart.component.html',
  styleUrls: ['./d3-pack-chart.component.scss']
})
export class D3PackChartComponent implements OnInit {
  _data;
  set data(val) {
    this._data = val;
