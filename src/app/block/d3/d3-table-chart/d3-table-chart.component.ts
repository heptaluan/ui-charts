...
@Component({
  selector: 'lx-d3-table-chart',
  templateUrl: './d3-table-chart.component.html',
  styleUrls: ['./d3-table-chart.component.scss']
})
export class D3TableChartComponent implements OnInit {
  _data;
  set data(val) {
    this._data = val;
