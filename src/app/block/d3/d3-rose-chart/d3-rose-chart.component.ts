...
@Component({
  selector: 'lx-d3-rose-chart',
  templateUrl: './d3-rose-chart.component.html',
  styleUrls: ['./d3-rose-chart.component.scss']
})
export class D3RoseChartComponent implements OnInit {
  _data;
  set data(val) {
    this._data = val;
