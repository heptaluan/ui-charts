...
@Component({
  selector: 'lx-d3-slope-chart',
  templateUrl: './d3-slope-chart.component.html',
  styleUrls: ['./d3-slope-chart.component.scss']
})
export class D3SlopeChartComponent implements OnInit {
