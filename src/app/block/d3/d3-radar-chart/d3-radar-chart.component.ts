...
@Component({
  selector: 'lx-d3-radar-chart',
  templateUrl: './d3-radar-chart.component.html',
  styleUrls: ['./d3-radar-chart.component.scss']
})
export class D3RadarChartComponent implements OnInit {
  _data;
  set data(val) {
    this._data = val;
