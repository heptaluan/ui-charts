...
import { InitializeProjectComponent, ProjectSizeLimitComponent, UpgradeMemberComponent, DataDemandFeedbackComponent, MobileDychartModelComponent } from '../../components/modals';
...
export class HomePageComponent implements OnInit {
  ...
  linkRedirect() {
    if (!this.isLogin) {
      window.location.href = "https://dycharts.com/vis/auth/signin.html?redirect=https%3A%2F%2Fdycharts.com%2Fappv2%2F%23%2Fpages%2Fhome%2Findex";
    } else {
      this.showModel();
    }
  }
