...
function handleAllChartsData(newBlock) {
  ...
  switch (newBlock.templateSwitch) {
    ...
    case 'key-value': {
      ...
      } else if (newBlock.templateId === '154778171740391769' || newBlock.templateId === '154777820323716078' || newBlock.templateId === '154778145806026722') {
        legendList.length = 1;
        // 取第一行第一个值
    ...
    case 'obj-n-value': {
      let trueIndex = 0;
      // 散点图 分组气泡图 三元图
      if (newBlock.templateId === '7955555555502346002' || newBlock.templateId === '4612096174443311107' || newBlock.templateId === '7955555777700001209') {
