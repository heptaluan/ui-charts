    ...
    if (this.curBlock) {
      ...
      if (this.shadowOpacity !== 100) {
        if (this.shadowColor.length === 4) {
          this.shadowColor = this.shadowColor[0] + this.shadowColor[1] + this.shadowColor[1]
            + this.shadowColor[2] + this.shadowColor[2]
            + this.shadowColor[3] + this.shadowColor[3]
        }
        this.shadowColor = this.shadowColor.substring(0, 7) + Math.round(this.shadowOpacity * 2.55).toString(16).padStart(2, "0");
