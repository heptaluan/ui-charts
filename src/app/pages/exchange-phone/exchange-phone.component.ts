...
export class ExchangePhoneComponent implements OnInit {
  ...
  constructor(private _store: Store<fromRoot.State>, private _api: API, private _http: HttpClient) {}
  ...
  link(flag) {
    if (flag) {
      window.location.href =
        ...
        encodeURIComponent(`${window.location.href.split('#')[0]}#/pages/exchange`)
    } else {
