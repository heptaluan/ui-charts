...
export class MediaOperationsComponent implements OnInit {
  ...
  records = [
    {
      text: '让繁杂的数据变简明，让复杂的编程“傻瓜化”，让重要新闻可视化。镝数图表帮助媒体人从大数据中挖掘新闻要点，高效利用数据工具，无门槛制作数据新闻产品，更好地专注于新闻本身，实现新闻数据化，用数据讲述好新闻。',
      name: '马轶群',
      position: '新华社融媒体产品创新中心总监',
    },
    {
      text: '镝次元是谷雨数据的重要合作伙伴。不论是针对新闻突发事件还是大事件节点，我们和镝次元的合作，都能看到他们专业的数据洞察和分析能力，充分展现了数据在新闻报道中的价值。',
      name: '杨瑞春',
      position: '腾讯网副总编辑',
    },
    {
      text: '零代码的制作流程，多样化的模板选择，镝数图表消除了很多人在“我希望我的图可交互”和“我不会写代码”之间的两难困境。让技术为更多普通人所用，让数据之美渗透到中国的新闻业，让新闻不仅有阅读价值，也有“观赏价值”。',
      name: '黄晨',
      position: '财新数据新闻中心主任',
    },
  ]
