...
export class ProjectService {
  ...
  updateProjectContent(projectId: string, data: ProjectModels.UpdateProjectContent): Observable<any> {
    ...
    switch (data.method) {
      case 'add':
        return this._http.post<CommonResponse<any>>(updateProjectContentUrl, _.omit(data, 'target'), {
          withCredentials: true,
        })
      case 'put':
        return this._http.put<CommonResponse<any>>(updateProjectContentUrl, _.omit(data, 'target'), {
          withCredentials: true,
        })
      case 'delete':
