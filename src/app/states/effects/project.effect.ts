...
export class ProjectEffect {
  ...
  getProjectList$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.GetProjectListAction) =>
      this._service.getProjectList().pipe(map((res) => new ProjectActions.GetProjectListSuccessAction(res.projects)))
    )
  )
  ...
  getSingleChartProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.GetSingleChartProjectAction) =>
      this._service
        .getSingleChartProject()
        .pipe(map((res) => new ProjectActions.GetSingleChartProjectSuccessAction(res.projects)))
    )
  )
  ...
  getAllProjectList$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.GetAllProjectListAction) =>
      this._service
        .getAllProjectList()
        .pipe(map((res) => new ProjectActions.GetAllProjectListSuccessAction(res.projects)))
    )
  )
  ...
  getProjectTheme$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.GetProjectThemeAction) =>
      this._service.getThemeList().pipe(map((res) => new ProjectActions.GetProjectThemeSuccessAction(res)))
    )
  )
  ...
  getProjectInfo$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.GetProjectInfoAction) =>
      this._service
        .getProject(data.id, data.projectType)
        .pipe(map((res) => new ProjectActions.GetProjectInfoSuccessAction(res)))
    )
  )
  ...
  getSingleChartInfo$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.GetSingleChartInfoAction) =>
      this._service
        .getSingleChart(data.id, data.projectType)
        .pipe(map((res) => new ProjectActions.GetSingleChartInfoSuccessAction(res)))
    )
  )
  ...
  getChartProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.GetChartProjectAction) =>
      this._service.getProject(data.payload, 'chart').map((res) => new ProjectActions.GetChartProjectSuccessAction(res))
    )
  )
  ...
  createProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.CreateProjectAction) =>
      this._service.createProject(data.payload).map((res) => new ProjectActions.CreateProjectSuccessAction(res.data))
    )
  )
  ...
  deleteProjectList$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((deleteArr) =>
      this._service.deleteProjectList(deleteArr).pipe(
        map((res) => {
  ...
  configProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.ConfigProjectAction) =>
      this._service.configProject(data.id, data.payload).pipe(
        map((res) => {
          if (res.resultCode === 1000) {
  ...
  configChartProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.ConfigChartProjectAction) =>
      this._service.configChartProject(data.id, data.payload).pipe(
        map((res) => {
          if (res.resultCode === 1000) {
            // 如果携带了 isNoToastrTip 值为 true 不提示修改成功
            const isTip = data.payload.isNoToastrTip ? false : true
  ...
  savingProject$: Observable<Action> = this._actions$.pipe(
    ...
    mergeMap((data: ProjectActions.SavingProjectAction) =>
      this._service.updateProjectContent(data.projectId, data.payload).pipe(
  ...
  deleteProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.DeleteProjectAction) =>
      this._service
  ...
  savingChartProject$: Observable<Action> = this._actions$.pipe(
    ...
    mergeMap((data: ProjectActions.SavingChartProjectAction) =>
  ...
  deleteChartProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.DeleteChartProjectAction) =>
      this._service
        .deleteChartProject(data.projectId)
  ...
  updateAndExitCurrentProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.UpdateAndExitCurrentProjectAction) =>
      this._service.configProject(data.projectId, data.payload).map((res) => {
  ...
  updateAndExitCurrentChartProject$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectActions.UpdateAndExitCurrentChartProjectAction) =>
      this._service.configChartProject(data.projectId, data.payload).map((res) => {
