...
export class ProjectCaseEffect {
  ...
  getProjectCaseDetail$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectCaseActions.GetProjectCaseDetailAction) =>
      this._service
        .getProjectGetDetail(data.id)
        .pipe(map((res) => new ProjectCaseActions.GetProjectCaseDetailSuccessAction(res)))
    )
  )
  ...
  getProjectChartCaseDetail$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: ProjectCaseActions.GetProjectChartCaseDetailAction) =>
      this._service
        .getChartProjectDetail(data.id)
        .pipe(map((res) => new ProjectCaseActions.GetProjectChartCaseDetailSuccessAction(res)))
    )
  )
  ...
  toggleListCase$ = this._actions$.pipe(
    ...
    switchMap((data: ProjectCaseActions.ToggleLikeCaseAction) =>
      this._service.toggleCaseLike(data.payload).pipe(
        map((res) => {
  ...
  constructor(private _service: ProjectCaseService, private _actions$: Actions, private toastr: ToastrService) {}
}
