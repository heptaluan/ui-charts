...
export class TemplateEffect {
  ...
  getProjectTemplateList$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap((data: TemplateActions.GetProjectTemplateListAction) =>
      this._service.getProjectTemplateList(data.payload).pipe(
  ...
  getChartTemplateList$: Observable<Action> = this._actions$.pipe(
    ...
    switchMap(() =>
      this._service.getChartTemplateList().map((res) => new TemplateActions.GetChartTemplateListSuccessAction(res))
    )
  )
