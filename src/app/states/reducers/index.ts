...
export const getRedoUndoUpdateTypeAndData = createSelector(
  getRedoUndoUpdateType,
  getRedoUndoUpdateData,
...
export const getCurrentProjectFull = createSelector(
  getCurrentProject,
  getCurrentProjectArticle,
  (basic, content): ProjectInfo => {
    if (basic && content) {
...
export const getCurrentChartProjectFull = createSelector(
  getCurrentChartProject,
  getCurrentChartArticle,
  (basic, content): ProjectInfo => {
    if (basic && content) {
      const fullInfo = _.cloneDeep(basic)
      Object.assign(fullInfo, {
...
export const getProjectTemplateCurrentTypeList = createSelector(
  getProjectTemplates,
  getProjectTemplatesCurrentType,
