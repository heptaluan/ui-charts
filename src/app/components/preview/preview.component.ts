...
export class PreviewComponent implements OnInit, OnChanges {
  ...
  setBlockStyle(indexEl) {
    this._render.setStyle(
      this._el.nativeElement.getElementsByClassName('block-container')[indexEl],
      'transform-origin',
      '0 0'
    )
    this._render.setStyle(
    ...
    this._render.setStyle(
      this._el.nativeElement.getElementsByClassName('block-container')[indexEl],
      'top',
      this.scaleContents.pages[0].blocks[indexEl].position.top + 'px'
    )
    this._render.setStyle(
      this._el.nativeElement.getElementsByClassName('block-container')[indexEl],
      'left',
      this.scaleContents.pages[0].blocks[indexEl].position.left + 'px'
    )
  }
  ...
  setPageStyle() {
    this._render.setStyle(
      ...
      'height',
      Number(this.scaleContents.design.height) + 'px'
    )
    this._render.setStyle(
      this._el.nativeElement.getElementsByClassName('page')[0],
      'width',
      this.scaleContents.design.width + 'px'
    )
    this._render.setStyle(
      this._el.nativeElement.getElementsByClassName('page')[0],
      'backgroundColor',
      this.colorToRGBA(this.scaleContents.design.backgroundColor)
    )
    ...
    if (this.isPhone) {
      ...
      this._render.setStyle(
        this._el.nativeElement.getElementsByClassName('page-container')[0],
        'height',
        originHeight + 'px'
      )
    ...
    if (this.isScale) {
      ...
      const scaleHeight =
        (Number(this.scaleContents.design.height) / Number(this.scaleContents.design.width)) * 700 + 'px'
