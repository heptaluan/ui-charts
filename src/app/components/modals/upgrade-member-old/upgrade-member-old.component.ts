...
@Component({
  selector: 'lx-upgrade-member-old',
  templateUrl: './upgrade-member-old.component.html',
  styleUrls: ['./upgrade-member-old.component.scss'],
})
export class UpgradeMemberOldComponent implements OnInit {
